...
/**
 * Built once on first request (not at import) so a malformed `STOREFRONT_KEY_HISTORY`
 * surfaces through `reconcileStorefrontKeys()` at boot with a clear message, not as an
