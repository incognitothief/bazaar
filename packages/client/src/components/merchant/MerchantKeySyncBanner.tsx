...
export function MerchantKeySyncBanner() {
  ...
  return (
    <div className="mb-3 flex flex-wrap items-center gap-x-2 gap-y-1 rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-sm text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-100">
      ...
      <span className="min-w-0 flex-1">
        ...
        <code className="rounded bg-amber-100 px-1 py-0.5 text-xs text-amber-800 dark:bg-amber-500/15 dark:text-amber-200/90">
          {counts}
        </code>
        {error ? (
